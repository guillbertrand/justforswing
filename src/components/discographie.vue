<template>
  ...
  <div class="container p-10 lg:p-20   mx-auto p-">
...
<p style="text-align:right"><a href="http://ctdf.free.fr/danielgivone/" target="_blank"><strong class="font-aleo text-3xl">Daniel Givone</strong></a><small class="text-xs">&nbsp;&nbsp;Mars 2014</small></p>
          <p class="mt-5 font-open text-sm">
